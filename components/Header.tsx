          ...
          <div className="flex justify-between items-center h-full">
            ...
            <div className="flex items-center gap-4">
              ...
              <Link to="/" className="flex items-center gap-2">
                ...
                <span className="font-display font-extrabold text-2xl tracking-tight hidden xs:block">
            ...
            <div className="flex items-center justify-between mb-10">
              <Link to="/" className="flex items-center gap-2" onClick={() => setIsMenuOpen(false)}>
                <div className="relative w-8 h-8 flex items-center justify-center">
                  <span className="material-icons text-secondary text-3xl absolute -top-1">local_florist</span>
                  <span className="material-icons text-primary text-xl absolute top-0.5">eco</span>
                </div>
